...
for (let i = 0; i < EXTRA_FILM_CARDS_COUNT; i++) {
  render(topRatedFilmsListContainer, createTopRatedCardTemplate(), `beforeend`);
}
...
for (let i = 0; i < EXTRA_FILM_CARDS_COUNT; i++) {
  render(mostCommentedFilmsListContainer, createMostCommentedCardTemplate(), `beforeend`);
}
